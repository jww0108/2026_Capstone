...
import { Chip, FooterActions, StatRow } from "@/components/Common"
import { Button } from "@/components/ui/button"
import { ScoreRing } from "@/components/ScoreRing"
import type { EvaluationItem, RepoAnalysis, RepoScore, Tone } from "@/types/analysis"
...
export function RepoAnalysisPanel({
  ...
  return (
    <>
      <Card className="h-[205px] p-5">
        <div className="grid h-full grid-cols-[1.08fr_230px_1fr] items-center gap-6">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-5">
            <Meta label="레포 유형" value={repo.type} image="/images/person.png" />
            ...
            <div>
              ...
              <div className="mt-2 flex min-h-[74px] content-start flex-wrap gap-2">
      ...
      <div className="mt-4 grid grid-cols-[1fr_540px] items-stretch gap-5">
        ...
        <div className="flex h-full flex-col gap-4">
          <Card className="p-5">
            ...
            <StatRow label="지원자 유효 LOC" value={repo.locUser} />
            <StatRow label="활성 기간 (전체)" value={repo.activeWeeks} />
